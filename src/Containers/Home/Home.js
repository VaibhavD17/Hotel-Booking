        ...
        <div className="">
               ...
               <div className="hotel-check">
                ...
                <div className="aboutData">
                    ...
                    <div className="about-details">
                        ...
                        <button type="button" className="btn commun-button">About us</button>
                    ...
                    <div className="room-details-box">
                        <div className="room-details">
                            <div className="room-img">
                                ...
                                <img src={'/assets/image/room-img-1.png'} />
                            </div>
                        ...
                        <div className="room-details">
                            <div className="room-img">
                                ...
                                <img src={'/assets/image/room-img-2.jpg'} />
                            </div>
                            <div className="room-data">
                                <div className="king-room">
                                    <h4>Deluxe King Room</h4>
                        ...
                        <div className="room-details">
                            <div className="room-img">
                                ...
                                <img src={'/assets/image/room-img-3.jpg'} />
                            </div>
                            <div className="room-data">
                                <div className="king-room">
                                    <h4>Deluxe King Room</h4>
            ...
            <section id="dinning">
                <div className='aboutData'>
                    ...
                    <div className='about-img'>
                        <img src={'/assets/image/dinning-group.png'}></img>
                    </div>
                </div>
            </section>
            ...
            <section id="subscribe">
                <div className="subscrib-data">
                    <img src={'/assets/image/subscribe.jpg'} />
                        ...
                        <div className="col-xl-4 guests-data">
                            ...
                            <div className="guest-info">
                                <div className="img-box-info">
                                    <img src={'/assets/image/Mirana.png'} />
                                </div>
                                <h4>Mirana Marci</h4>
                            </div>
                        </div>
            ...
            <section id="download">
                <div className="subscrib-data">
                    ...
                    <div className="newsletter margin-30">
            ...
            <section id="visitPage">
                <div className="visit">
                    <img src={'/assets/image/Group-visit.png'} />
